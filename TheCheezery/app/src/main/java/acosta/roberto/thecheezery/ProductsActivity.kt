...
class ProductsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var adaptador = AdaptorProductos(this,coldDrinks)
        ...
        if(bundle!=null){
            ...
            when(type){
                "coldDrinks" -> adaptador = AdaptorProductos(this,coldDrinks)
                "hotDrinks" -> adaptador = AdaptorProductos(this,hotDrinks)
                "sweets" -> adaptador = AdaptorProductos(this,sweets)
                "salties" -> adaptador = AdaptorProductos(this,salties)
            }
